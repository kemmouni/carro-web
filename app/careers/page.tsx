...
export const metadata: Metadata = {
  title: "Careers — Carro Qatar",
  description: "Join the Carro team and help build Qatar's leading auto parts marketplace.",
};
  ...
  return (
    <div className="min-h-screen bg-dark-primary py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-10">
          <h1 className="text-[32px] font-black text-white mb-3">Careers at Carro</h1>
          <p className="text-[15px] text-gray-400">Help us build Qatar's leading auto parts marketplace.</p>
        </div>

        <div className="card p-8 mb-6">
          <h2 className="text-[20px] font-black text-white mb-3">Why join Carro?</h2>
        ...
        <div className="card p-8 mb-6">
          ...
          <div className="space-y-4">
            {[
              ...
              { title: "Customer Success Specialist", type: "Part-time / Full-time · Doha", desc: "Support sellers in setting up and growing their stores on Carro." },
            ].map(({ title, type, desc }) => (
