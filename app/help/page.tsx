...
export const metadata: Metadata = {
  title: "Help Center — Warsha+ Qatar",
  description: "Find answers to common questions about buying and selling on Warsha+ Qatar.",
};

const faqs: { q: string; a: string }[] = [
  { q: "Is Warsha+ free to use?", a: "Browsing and buying is always free. Sellers can list up to 10 products for free on the Starter plan. Pro and Business plans unlock more listings and advanced features." },
  ...
  { q: "What payment methods are accepted?", a: "Payment is arranged directly between buyer and seller. Warsha+ supports Cash on Delivery (COD) ordering through the platform, and sellers may accept bank transfer, QNB Pay, or cash in person." },
  ...
  { q: "How can I contact Warsha+ support?", a: "Email us at support@warsha.plus or use WhatsApp for the fastest response. We're available Sunday–Thursday, 8 AM–6 PM." },
];
    ...
    <div className="min-h-screen bg-dark-primary py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <p className="text-[15px] text-gray-400">Answers to the most common questions about Warsha+.</p>
        </div>
